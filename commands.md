...
set_premium_users_only - only allows premium users to be in this chat (will be checked on every update to the chat - kick of existing non-premium users is possible)
```
